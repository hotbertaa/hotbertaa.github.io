...
$('.scrollTo').on('click', function(){
    ...
    if($(this).parents('.window').length > 0 ){
        ...
        if($(this).attr('href')=="#intro"){ $('html,body').animate({scrollTop: $($(this).attr('href')).offset().top -140 }, 'slow'); }
        else if($(this).attr('href')=="#geronigo"){ $('html,body').animate({scrollTop: $($(this).attr('href')).offset().top -60 }, 'slow'); }
        else if($(this).attr('href')=="#rezbot"){ $('html,body').animate({scrollTop: $($(this).attr('href')).offset().top +30 }, 'slow'); }
        else if($(this).attr('href')=="#about"){ $('html,body').animate({scrollTop: $($(this).attr('href')).offset().top +20 }, 'slow'); }
